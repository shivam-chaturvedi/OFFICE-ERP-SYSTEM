...
const ManageUsers = () => {
  const [users, setUsers] = useState([
    ...
    },
    {
      _id: '2',
      name: 'Mukesh Kumar',
      email: 'mukesh.kumar@company.com',
      phone: '+91 9876543211',
      position: 'Team Lead',
      salary: '75000',
    ...
    },
    {
      _id: '4',
      name: 'Rakesh Gupta',
      email: 'rakesh.gupta@company.com',
      phone: '+91 9876543213',
    ...
    },
    {
      _id: '5',
      name: 'Supriya Patel',
      email: 'supriya.patel@company.com',
      phone: '+91 9876543214',
  ...
  const adminCount = users.filter(user => user.roles && user.roles.includes('admin')).length;
  const hrCount = users.filter(user => user.roles && user.roles.includes('hr')).length;
  const pmCount = users.filter(user => user.roles && user.roles.includes('project_manager')).length;

  const getRoleBadgeColor = (role) => {
    switch(role) {
      case 'admin': return 'bg-red-100 text-red-700';
      case 'hr': return 'bg-blue-100 text-blue-700';
      case 'project_manager': return 'bg-green-100 text-green-700';
                ...
                <tr key={user._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 capitalize">
                      {user.position === 'Frontend Developer' || user.position === 'System Administrator' ? 'Engineering' :
                       user.position === 'HR Manager' || user.position === 'HR Executive' || user.position === 'HR Specialist' ? 'Human Resources' :
                       user.position === 'Team Lead' || user.position === 'Project Manager' ? 'Engineering' :
                       user.position === 'Senior Manager' ? 'Human Resources' : 'General'}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500">

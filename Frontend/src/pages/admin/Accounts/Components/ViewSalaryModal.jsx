      ...
      <div className="bg-white w-full max-w-7xl max-h-[95vh] overflow-y-auto rounded-lg shadow-xl">
        ...
        <div className="flex justify-between items-center p-6 border-b bg-gray-50">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">John Smith - Salary Processing</h1>
        ...
        <div className="bg-blue-50 p-4 flex items-center gap-2 border-b">
          ...
          <span className="text-blue-600">•</span>
          <span className="text-blue-800 font-medium">Month: December 2024</span>
        </div>
          ...
          <div className="w-80 border-r bg-gray-50 p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full flex items-center gap-3 p-3 text-left border border-gray-200 rounded-md hover:bg-white hover:shadow-sm">
                ...
                <span className="text-sm font-medium text-gray-700">Generate Payslip</span>
              </button>
              <button className="w-full flex items-center gap-3 p-3 text-left border border-gray-200 rounded-md hover:bg-white hover:shadow-sm">
                <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                  ✈️
                </div>
                <span className="text-sm font-medium text-gray-700">Send to Payroll</span>
              </button>
              <button className="w-full flex items-center gap-3 p-3 text-left border border-gray-200 rounded-md hover:bg-white hover:shadow-sm">
                <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                  📥
            ...
            <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">2020-01-15</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Department</p>
                          <p className="text-base font-medium text-gray-900">IT</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Designation</p>
                          <p className="text-base font-medium text-gray-900">Senior Developer</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Grade</p>
                          <p className="text-base font-medium text-gray-900">L3</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">HDFC Bank</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Account Number</p>
                          <p className="text-base font-medium text-gray-900">50100123456789</p>
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">ABCDE1234F</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">PF No</p>
                          <p className="text-base font-medium text-gray-900">MH/12345/67890</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">UAN</p>
                          <p className="text-base font-medium text-gray-900">123456789012</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === 'salary' && (
                <div>
                  <div className="grid grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">Period Details</h3>
                      <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm text-gray-500 mb-1">Paid Days</p>
                        ...
                        <div>
                          <p className="text-sm text-gray-500 mb-1">Arrear Days</p>
                          <p className="text-base font-medium">0</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500 mb-1">Days in Month</p>
                          <p className="text-base font-medium">31</p>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-red-700">₹14,400</span>
                    </div>
                  </div>
                  <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="text-lg font-semibold text-blue-700">Net Pay</span>
                      <span className="text-2xl font-bold text-blue-700">₹70,750</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div>
                  <div className="grid grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="space-y-4">
                        {Object.entries(taxSummaryData).slice(0, 2).map(([key, value]) => (
                          <div key={key} className="flex justify-between items-center py-2 border-b border-gray-100">
                            <span className="text-sm text-gray-700">{key}</span>
                            <span className="text-sm font-medium text-gray-900">{value}</span>
                          </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {Object.entries(taxSummaryData).slice(2).map(([key, value]) => (
                          <div key={key} className="flex justify-between items-center py-2 border-b border-gray-100">
                            <span className="text-sm text-gray-700">{key}</span>
                            <span className="text-sm font-medium text-gray-900">{value}</span>
                          </div>
                    ...
                    <table className="min-w-full bg-white border border-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Basic Paid</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rent Paid</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Is Metro</th>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {['Jan', 'Feb', 'Mar'].map(month => (
                          <tr key={month}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">₹18,000</td>
